...
import com.example.coderswag_2.Adapters.ProductsAdapter
...
class ProductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = ProductsAdapter(this@ProductsActivity,
        ...
        val layoutManager = GridLayoutManager(this@ProductsActivity, spanCount)
